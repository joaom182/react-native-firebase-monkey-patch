...
throw new Error('AndroidNotifications:removeDeliveredNotificationsByTag expects an \'string\' but got type '+
typeof tag);

}
return(0,_native.getNativeModule)(
this._notifications).
...
throw new Error('AndroidNotifications:deleteChannelGroup expects an \'string\' but got type '+
typeof groupId);
...
throw new Error('AndroidNotifications:deleteChannel expects an \'string\' but got type '+
typeof channelId);
